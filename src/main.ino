//https://github.com/markruys/arduino-Max72xxPanel/tree/master/examples/Ticker
...
String tape = "Everybody is a genius. But if you judge a fish by its ability to climb a tree, it will live its whole life believing that it is stupid.";
